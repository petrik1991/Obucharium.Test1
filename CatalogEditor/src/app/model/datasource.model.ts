...
export class DataSource{
    ...
    constructor(){
        this.categoriesData = new Array<Category>(
            new Category("Одежда, обувь, аксессуары", false, new Array<Category>(new Category("Женская одежда", false, new Array<Category>(new Category("Верхняя", false)))))
        );

        this.productsData = new Array<Product>(
            new Product(1, "Юбка", 23.25, this.categoriesData[0], '../../assets/jeans.jpg'),
            new Product(2, "Кофта", 43.75, this.categoriesData[0], ""),
            new Product(3, "Шорты", 13.35, this.categoriesData[0], ""),
            new Product(4, "Джинсы", 3.05, this.categoriesData[0], '../../assets/jeans.jpg' ),
